...
import es.caib.zkib.jxpath.util.KeyManagerUtils;
 ...
 *         "es.caib.zkib.jxpath.example.Book.new ('John Updike')");
 * </blockquote></pre>
 *
...
public abstract class JXPathContext {
	 ...
	 */
	public synchronized boolean isIgnoreExceptions() {
        if (ignoreExceptions && parentContext != null) {
            return parentContext.isIgnoreExceptions();
        }
	 ...
	 */
	public synchronized void setIgnoreExceptions(boolean ignoreExceptions) {
