...
public abstract class JXPathContextFactory {
    ...
    public static final String FACTORY_NAME_PROPERTY =
        "es.caib.zkib.jxpath.JXPathContextFactory";

    /** The default factory class */
    private static final String DEFAULT_FACTORY_CLASS =
        "es.caib.zkib.jxpath.ri.JXPathContextFactoryReferenceImpl";
    ...
    */
     ...
     * <ul>
     * <li>
     * Use  the <code>es.caib.zkib.jxpath.JXPathContextFactory</code>
     * system property.
     * </li>
     * <li>
     ...
     * <code>es.caib.zkib.jxpath.JXPathContextFactory</code>.
     * </li>
     * <li>
     * Use the Services API (as detailed in the JAR specification), if
     * available, to determine the classname. The Services API will look
     * for a classname in the file
     * <code>META- INF/services/<i>es.caib.zkib.jxpath.
