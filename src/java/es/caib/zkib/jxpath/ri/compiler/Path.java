...
import es.caib.zkib.jxpath.ri.axes.AncestorContext;
import es.caib.zkib.jxpath.ri.axes.AttributeContext;
import es.caib.zkib.jxpath.ri.axes.ChildContext;
import es.caib.zkib.jxpath.ri.axes.DescendantContext;
import es.caib.zkib.jxpath.ri.axes.InitialContext;
import es.caib.zkib.jxpath.ri.axes.NamespaceContext;
import es.caib.zkib.jxpath.ri.axes.ParentContext;
import es.caib.zkib.jxpath.ri.axes.PrecedingOrFollowingContext;
import es.caib.zkib.jxpath.ri.axes.PredicateContext;
import es.caib.zkib.jxpath.ri.axes.SelfContext;
import es.caib.zkib.jxpath.ri.axes.SimplePathInterpreter;
import es.caib.zkib.jxpath.ri.axes.UnionContext;
