...
//        printPointerChain();
    ...
    public NodeIterator childIterator(
        ...
        return valuePointer == null || valuePointer == this ? null
                : valuePointer.childIterator(test, reverse, startWith, ignoreExceptions);
    }
     ...
     * @return NodeIterator
     */
    public NodeIterator attributeIterator(QName qname, boolean ignoreExceptions) {
        NodePointer valuePointer = getValuePointer();
        return valuePointer == null || valuePointer == this ? null
                : valuePointer.attributeIterator(qname, ignoreExceptions);
    }
