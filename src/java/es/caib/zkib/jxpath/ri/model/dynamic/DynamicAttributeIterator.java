...
import es.caib.zkib.jxpath.ri.model.beans.BeanAttributeIterator;
 ...
 * @version $Id: DynamicAttributeIterator.java,v 1.2 2009-04-03 12:19:35 u07286 Exp $
 */
public class DynamicAttributeIterator extends BeanAttributeIterator {
     ...
     */
    public DynamicAttributeIterator(PropertyOwnerPointer parent, QName name, boolean ignoreExceptions) {
        super(parent, name, ignoreExceptions);
    }
