 ...
 */
package es.caib.zkib.jxpath.ri.model.dynamic;
...
import es.caib.zkib.jxpath.ri.model.beans.PropertyIterator;
...
public class DynamicPointer extends PropertyOwnerPointer {
    ...
    public NodeIterator createNodeIterator(
                String property, boolean reverse, NodePointer startWith, boolean ignoreExceptions) {
        return new PropertyIterator(this, property, reverse, startWith, ignoreExceptions);
    }

    public NodeIterator attributeIterator(QName name, boolean ignoreExceptions) {
        return new DynamicAttributeIterator(this, name, ignoreExceptions);
    }
