...
import es.caib.zkib.jxpath.JXPathAbstractFactoryException;
import es.caib.zkib.jxpath.JXPathContext;
import es.caib.zkib.jxpath.JXPathException;
import es.caib.zkib.jxpath.ri.Compiler;
import es.caib.zkib.jxpath.ri.NamespaceResolver;
...
import es.caib.zkib.jxpath.ri.compiler.ProcessingInstructionTest;
...
public class JDOMNodePointer extends NodePointer {
    ...
    public Object getValue() {
        if (node instanceof Element) {
            ...
            for (NodeIterator children = childIterator(null, false, null, true); children.setPosition(children.getPosition() + 1);) {
    ...
    public NodePointer createChild(
        ...
        if (success) {
            ...
            NodeIterator it =
                childIterator(nodeTest, false, null, context.isIgnoreExceptions());
    ...
    public NodePointer createAttribute(JXPathContext context, QName name) {
        ...
        NodeIterator it = attributeIterator(name, context.isIgnoreExceptions());
        it.setPosition(1);
        return it.getNodePointer();
    }
