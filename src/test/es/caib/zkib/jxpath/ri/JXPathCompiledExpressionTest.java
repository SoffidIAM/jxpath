...
import es.caib.zkib.jxpath.ri.JXPathCompiledExpression;
import es.caib.zkib.jxpath.ri.compiler.Constant;
import es.caib.zkib.jxpath.ri.compiler.CoreFunction;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationAdd;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationAnd;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationDivide;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationEqual;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationGreaterThan;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationGreaterThanOrEqual;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationLessThan;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationLessThanOrEqual;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationMod;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationMultiply;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationNegate;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationNotEqual;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationOr;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationSubtract;
import es.caib.zkib.jxpath.ri.compiler.CoreOperationUnion;
import es.caib.zkib.jxpath.ri.compiler.ExpressionPath;
import es.caib.zkib.jxpath.ri.compiler.ExtensionFunction;
import es.caib.zkib.jxpath.ri.compiler.LocationPath;
import es.caib.zkib.jxpath.ri.compiler.NameAttributeTest;
import es.caib.zkib.jxpath.ri.compiler.VariableReference;
