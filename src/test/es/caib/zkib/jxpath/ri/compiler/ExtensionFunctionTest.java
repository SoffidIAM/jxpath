...
import es.caib.zkib.jxpath.util.JXPath11CompatibleTypeConverter;
import es.caib.zkib.jxpath.util.TypeConverter;
        ...
        if (context == null) {
            ...
            lib.addFunctions(
                new PackageFunctions(
                    "es.caib.zkib.jxpath.ri.compiler.",
                    "jxpathtest"));
