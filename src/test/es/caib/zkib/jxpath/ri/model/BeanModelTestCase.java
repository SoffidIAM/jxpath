...
import es.caib.zkib.jxpath.ri.compiler.TestFunctions;
...
import es.caib.zkib.jxpath.ri.model.dynabeans.DynaBeanModelTest;
...
//        }
        ...
        int expected) 
    {
        ...
        it = root.childIterator(null, reverse, start, true);
